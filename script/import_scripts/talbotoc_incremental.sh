...

{
  ...
  [[ -n "${TALBOTOC_TOPIC_OFFSET:-}" ]] && import_env+=("TALBOTOC_TOPIC_OFFSET=${TALBOTOC_TOPIC_OFFSET}")
  [[ -n "${TALBOTOC_DRY_RUN:-}" ]] && import_env+=("TALBOTOC_DRY_RUN=${TALBOTOC_DRY_RUN}")
  [[ -n "${TALBOTOC_FAST_INCREMENTAL:-}" ]] &&
    import_env+=("TALBOTOC_FAST_INCREMENTAL=${TALBOTOC_FAST_INCREMENTAL}")
